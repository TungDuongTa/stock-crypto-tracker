...
export default async function CoinsDetails({ params }: StockDetailsPageProps) {
  ...
  const fullSymbol = `${symbol.trim().toUpperCase()}USDT`;
  const scriptUrl = `https://s3.tradingview.com/external-embedding/embed-widget-`;
  //   const stockData = await getStockDetails(symbol.trim().toUpperCase());
  ...
  return (
    <>
      {/* <WatchlistSync initialSymbols={allSymbols} /> */}
